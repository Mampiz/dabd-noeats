...
function Clientes() {
    ...
    const handleCreateClient = async () => {
        try {
            ...
            setError("Could not create the client. Please try again later.");
        }
    };
                    ...
                    <li className="border rounded-lg hover:bg-gray-300 shadow-md" key={index}>
                        <div className="hover:scale-10 transition flex flex-col h-5/6 w-full p-4">
                            ...
                            <div className="flex justify-between">
                                <button
                                    className="w-2/5 mt-6 inline-flex items-center px-4 py-2 bg-[#2F695Cff] transition ease-in-out delay-75 hover:bg-[#285c4f] text-white text-sm font-medium rounded-md hover:-translate-y-1 hover:scale-110"
                                ...
                                <button
                                    className="w-2/5 mt-6 inline-flex items-center px-4 py-2 bg-red-800 transition ease-in-out delay-75 hover:bg-red-900 text-white text-sm font-medium rounded-md hover:-translate-y-1 hover:scale-110"
